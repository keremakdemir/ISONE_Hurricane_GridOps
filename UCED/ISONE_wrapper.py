...
from ISONE_dispatch import model as m1
from ISONE_dispatchLP import model as m2
...
def sim(days):
    ...
    Duals=[]
    System_cost = []
    df_generators = pd.read_excel('generators.xlsx',header=0,sheet_name='Generators (dispatch)')
